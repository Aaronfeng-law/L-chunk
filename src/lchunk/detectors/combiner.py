...
""" Combine the result of line-based and level-based chunking into paragraphs.
"""
...
class LineBasedChunkCombiner:
    """Combine line-based chunks into paragraphs."""

    def __init__(self, detector: AdaptiveHybridDetector | None = None, model_path: Path | str | None = None):
        """Initialize the combiner with an optional detector instance or model path."""
